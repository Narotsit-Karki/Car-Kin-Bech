"""
Django settings for CAR_KIN_BECH project.
...
SECRET_KEY = os.environ.get("CAR_KINBECH_SECRET_KEY")
...
ROOT_URLCONF = 'CAR_KIN_BECH.urls'
...
WSGI_APPLICATION = 'CAR_KIN_BECH.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'car_kin_bech',
        'USER': os.environ.get("CAR_KINBECH_USERNAME",'root'),
        'PASSWORD': os.environ.get("CAR_KINBECH_PASSWORD",''),
        'HOST': 'localhost',
        'PORT':3306
    }
}
...
AUTH_USER_MODEL = "common.KinBechUser"
